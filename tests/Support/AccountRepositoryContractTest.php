...
abstract class AccountRepositoryContractTest extends TestCase
{
    ...
    public function testSavedAccountIsRebuiltFromItsEvents(): void
    {
        ...
        $account->placeHold($holdId, new Money(20, 'EUR'), $this->now);
        ...
        self::assertTrue($loaded->held->equals(new Money(20, 'EUR')));
        self::assertSame(4, $loaded->version);
        self::assertCount(4, $this->eventStore->load($accountId->value));
    }
